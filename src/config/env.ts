...
const envSchema = z.object({
  ...
  PRODUCT_HUNT_ENABLED: z.string().optional(),
  PRODUCT_HUNT_POST_LIMIT: z.string().optional(),
  PRODUCT_HUNT_DAYS_BACK: z.string().optional(),
  PRODUCT_HUNT_TOPICS: z.string().optional(),
  PRODUCT_HUNT_KEYWORDS: z.string().optional(),
  PRODUCT_HUNT_MIN_VOTES: z.string().optional(),
  PRODUCT_HUNT_MIN_COMMENTS: z.string().optional(),
  ...
  DIGEST_ARCHIVE_BASE_URL: z.string().optional(),
  ...
  DIGEST_NARRATIVE_LLM_ENABLED: z.string().optional(),
  DIGEST_NARRATIVE_MAX_OUTPUT_TOKENS: z.string().optional(),
  AI_RADAR_LLM_ENABLED: z.string().optional(),
  AI_RADAR_LLM_API_KEY: z.string().optional(),
  AI_RADAR_LLM_BASE_URL: z.union([z.string().url(), z.literal('')]).optional(),
  AI_RADAR_LLM_MODEL: z.string().optional(),
  AI_RADAR_LLM_LANGUAGE: z.string().optional(),
  AI_RADAR_LLM_TIMEOUT_MS: z.string().optional(),
  AI_RADAR_LLM_MAX_INPUT_ITEMS: z.string().optional(),
  AI_RADAR_LLM_TEMPERATURE: z.string().optional(),
  AI_RADAR_LLM_MAX_OUTPUT_TOKENS: z.string().optional(),
