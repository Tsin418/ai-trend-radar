...
**Generated:** 2026-07-09T05:18:16.310Z
...
- **Stars:** 74,607 (+2,287 / 24h, +6,204 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向出现突然加速：24h stars +2287，前 3 日均值 1120.3，加速度 2x，今天值得优先排查触发原因。
...
- **Stars:** 9,035 (+499 / 24h, +2,229 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向保持持续热门，24h stars +499，总 stars 9,035，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/TencentCloud/CubeSandbox)

### 3. mvanhorn/last30days-skill
- **Stars:** 50,909 (+1,149 / 24h, +11,797 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向保持持续热门，24h stars +1149，总 stars 50,909，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/mvanhorn/last30days-skill)

### 4. iOfficeAI/OfficeCLI
- **Stars:** 12,281 (+2,017 / 24h, n/a / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向保持持续热门，24h stars +2017，总 stars 12,281，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/iOfficeAI/OfficeCLI)

### 5. alibaba/zvec
- **Stars:** 14,498 (+989 / 24h, +3,290 / 7d)
- **Category:** RAG / Knowledge Base
- **Why it matters:** RAG / Knowledge Base 方向保持持续热门，24h stars +989，总 stars 14,498，适合看近期 release、commit 或社区讨论是否解释了增长。
...
- **Stars:** 53,381 (+601 / 24h, +5,013 / 7d)
- **Category:** MCP / Tool Calling
- **Why it matters:** MCP / Tool Calling 方向保持持续热门，24h stars +601，总 stars 53,381，适合看近期 release、commit 或社区讨论是否解释了增长。
...
- **Stars:** 35,780 (+636 / 24h, +4,874 / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向保持持续热门，24h stars +636，总 stars 35,780，适合看近期 release、commit 或社区讨论是否解释了增长。
...
- **Stars:** 54,421 (+1,247 / 24h, +6,751 / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向保持持续热门，24h stars +1247，总 stars 54,421，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 关注它如何拆解代码任务、接入工具和处理仓库上下文，可作为 coding agent 产品能力参考。
- **Risk:** Low
- [View on GitHub](https://github.com/asgeirtj/system_prompts_leaks)

### 9. HKUDS/nanobot
- **Stars:** 45,160 (+48 / 24h, +226 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向一周增长 +226，属于持续升温信号。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/HKUDS/nanobot)

### 10. getagentseal/codeburn
- **Stars:** 8,541 (+39 / 24h, +168 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向一周增长 +168，属于持续升温信号。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/getagentseal/codeburn)

### 11. obra/superpowers
- **Stars:** 250,073 (+4,454 / 24h, +7,539 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向出现突然加速：24h stars +4454，前 3 日均值 1542.5，加速度 2.9x，今天值得优先排查触发原因。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/obra/superpowers)

### 12. affaan-m/ECC
- **Stars:** 227,495 (+377 / 24h, +2,819 / 7d)
- **Category:** MCP / Tool Calling
- **Why it matters:** MCP / Tool Calling 方向保持持续热门，24h stars +377，总 stars 227,495，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 重点看协议适配、工具注册和真实示例，判断它是否能降低 agent 接工具的成本。
- **Risk:** Low
