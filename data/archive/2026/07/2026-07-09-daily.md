...
**Generated:** 2026-07-09T01:07:10.844Z

## Today's Summary

扫描到 100 个候选项目，AI 相关候选 97 个。 今日新增 stars >= 50 的 AI 项目不足 12 个，已补充 Early Signals。 发现 6 个突然加速项目。 当前最强信号集中在 RAG / Knowledge Base。

## Hot Projects

### 1. stas00/ml-engineering
- **Stars:** 18,266 (+17 / 24h, +71 / 7d)
- **Category:** RAG / Knowledge Base
- **Why it matters:** RAG / Knowledge Base 方向出现突然加速：24h stars +17，前 3 日均值 4，加速度 4.3x，今天值得优先排查触发原因。
...
- **Stars:** 36,012 (+22 / 24h, +111 / 7d)
- **Category:** Local LLM / Inference
- **Why it matters:** Local LLM / Inference 方向出现突然加速：24h stars +22，前 3 日均值 10.7，加速度 2.1x，今天值得优先排查触发原因。
...
- **Stars:** 74,084 (+3,253 / 24h, +5,890 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向出现突然加速：24h stars +3253，前 3 日均值 683.7，加速度 4.8x，今天值得优先排查触发原因。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/addyosmani/agent-skills)

### 8. TencentCloud/CubeSandbox
- **Stars:** 8,931 (+771 / 24h, +2,285 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向保持持续热门，24h stars +771，总 stars 8,931，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/TencentCloud/CubeSandbox)

### 9. calesthio/OpenMontage
- **Stars:** 35,661 (+1,313 / 24h, +5,740 / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向出现突然加速：24h stars +1313，前 3 日均值 612.7，加速度 2.1x，今天值得优先排查触发原因。
...
- **Stars:** 50,755 (+995 / 24h, +11,643 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向保持持续热门，24h stars +995，总 stars 50,755，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/mvanhorn/last30days-skill)

### 11. asgeirtj/system_prompts_leaks
- **Stars:** 54,198 (+2,651 / 24h, +6,791 / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向出现突然加速：24h stars +2651，前 3 日均值 1094.3，加速度 2.4x，今天值得优先排查触发原因。
- **Developer insight:** 关注它如何拆解代码任务、接入工具和处理仓库上下文，可作为 coding agent 产品能力参考。
- **Risk:** Low
- [View on GitHub](https://github.com/asgeirtj/system_prompts_leaks)

### 12. alibaba/zvec
- **Stars:** 14,409 (+900 / 24h, +3,201 / 7d)
- **Category:** RAG / Knowledge Base
- **Why it matters:** RAG / Knowledge Base 方向保持持续热门，24h stars +900，总 stars 14,409，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 重点看数据接入、检索质量和 production workflow，而不是只看 demo 效果。
- **Risk:** Low
...
- Trend enrichment warning: Trend LLM enrichment failed for Mistral's Robostral Navigate: a state of the art robotics navigation model: DeepSeek API request failed: HTTP 401. {"error":{"message":"Authentication Fails, Your api key: ****c776 is invalid","type":"authentication_error","param":null,"code":"invalid_request_error"}}
