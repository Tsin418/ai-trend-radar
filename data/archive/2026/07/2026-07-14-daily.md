...
**Generated:** 2026-07-14T09:21:52.354Z

## Today's Summary

扫描到 100 个候选项目，AI 相关候选 99 个。 今日 1 个项目达到 24h stars >= 50。 发现 3 个突然加速项目。 当前最强信号集中在 Vector Database / Embedding。

## Hot Projects

### 1. milvus-io/milvus
- **Stars:** 45,221 (+63 / 24h, +123 / 7d)
- **Category:** Vector Database / Embedding
- **Why it matters:** Vector Database / Embedding 方向出现突然加速：24h stars +63，前 3 日均值 20，加速度 3.2x，今天值得优先排查触发原因。
...
- **Stars:** 85,409 (+2,139 / 24h, +6,677 / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向出现突然加速：24h stars +2139，前 3 日均值 630，加速度 3.4x，今天值得优先排查触发原因。
...
- **Stars:** 22,302 (+1,776 / 24h, +4,869 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向保持持续热门，24h stars +1776，总 stars 22,302，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/HKUDS/Vibe-Trading)

### 6. HKUDS/nanobot
- **Stars:** 45,508 (+210 / 24h, +431 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向出现突然加速：24h stars +210，前 3 日均值 35.7，加速度 5.9x，今天值得优先排查触发原因。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/HKUDS/nanobot)

### 7. Panniantong/Agent-Reach
- **Stars:** 56,005 (+684 / 24h, +3,959 / 7d)
- **Category:** MCP / Tool Calling
- **Why it matters:** MCP / Tool Calling 方向保持持续热门，24h stars +684，总 stars 56,005，适合看近期 release、commit 或社区讨论是否解释了增长。
...
- **Stars:** 38,250 (+731 / 24h, +3,902 / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向保持持续热门，24h stars +731，总 stars 38,250，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 关注它如何拆解代码任务、接入工具和处理仓库上下文，可作为 coding agent 产品能力参考。
- **Risk:** Low
- [View on GitHub](https://github.com/calesthio/OpenMontage)

### 9. Shubhamsaboo/awesome-llm-apps
- **Stars:** 120,151 (+1,643 / 24h, +3,512 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向出现突然加速：24h stars +1643，前 3 日均值 453.7，加速度 3.6x，今天值得优先排查触发原因。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/Shubhamsaboo/awesome-llm-apps)

### 10. esengine/DeepSeek-Reasonix
- **Stars:** 26,915 (+161 / 24h, +710 / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向出现突然加速：24h stars +161，前 3 日均值 66.3，加速度 2.4x，今天值得优先排查触发原因。
- **Developer insight:** 关注它如何拆解代码任务、接入工具和处理仓库上下文，可作为 coding agent 产品能力参考。
- **Risk:** Low
- [View on GitHub](https://github.com/esengine/DeepSeek-Reasonix)

### 11. nexu-io/open-design
- **Stars:** 77,974 (+414 / 24h, +2,373 / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向保持持续热门，24h stars +414，总 stars 77,974，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 关注它如何拆解代码任务、接入工具和处理仓库上下文，可作为 coding agent 产品能力参考。
- **Risk:** Low
- [View on GitHub](https://github.com/nexu-io/open-design)

### 12. topoteretes/cognee
- **Stars:** 27,817 (+296 / 24h, +558 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向出现突然加速：24h stars +296，前 3 日均值 87.3，加速度 3.4x，今天值得优先排查触发原因。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
