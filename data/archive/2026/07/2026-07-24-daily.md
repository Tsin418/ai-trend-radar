...
**Generated:** 2026-07-24T15:51:07.355Z

## Today's Summary

扫描到 100 个候选项目，AI 相关候选 97 个。 今日 4 个项目达到 24h stars >= 50。 发现 6 个突然加速项目。 当前最强信号集中在 AI Agent Framework。

## Hot Projects

### 1. citrolabs/ego-lite
- **Stars:** 2,267 (+1,017 / 24h, n/a / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向保持持续热门，24h stars +1017，总 stars 2,267，适合看近期 release、commit 或社区讨论是否解释了增长。
...
- **Stars:** 4,119 (+2,102 / 24h, +2,102 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向保持持续热门，24h stars +2102，总 stars 4,119，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/CoreBunch/Instatic)

### 3. mattpocock/skills
- **Stars:** 186,249 (+12,043 / 24h, +12,043 / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向出现突然加速：24h stars +12043，前 3 日均值 1967，加速度 1x，今天值得优先排查触发原因。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
- [View on GitHub](https://github.com/mattpocock/skills)

### 4. Automattic/harper
- **Stars:** 12,830 (+998 / 24h, n/a / 7d)
- **Category:** MCP / Tool Calling
- **Why it matters:** MCP / Tool Calling 方向保持持续热门，24h stars +998，总 stars 12,830，适合看近期 release、commit 或社区讨论是否解释了增长。
...
- **Stars:** 28,330 (+3,098 / 24h, +18,778 / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向出现突然加速：24h stars +3098，前 3 日均值 1523.3，加速度 2x，今天值得优先排查触发原因。
...
- **Stars:** 26,142 (+836 / 24h, +6,569 / 7d)
- **Category:** MCP / Tool Calling
- **Why it matters:** MCP / Tool Calling 方向保持持续热门，24h stars +836，总 stars 26,142，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 重点看协议适配、工具注册和真实示例，判断它是否能降低 agent 接工具的成本。
- **Risk:** Low
