...
**Generated:** 2026-06-23T13:58:32.346Z

## Today's Summary

扫描到 100 个候选项目，AI 相关候选 99 个。 今日 3 个项目达到 24h stars >= 50。 发现 7 个突然加速项目。 当前最强信号集中在 MCP / Tool Calling。

## Hot Projects

### 1. anthropics/claude-plugins-official
- **Stars:** 30,708 (+3,329 / 24h, +3,329 / 7d)
- **Category:** MCP / Tool Calling
- **Why it matters:** MCP / Tool Calling 方向保持持续热门，24h stars +3329，总 stars 30,708，适合看近期 release、commit 或社区讨论是否解释了增长。
...
- **Stars:** 47,936 (+1,827 / 24h, n/a / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向保持持续热门，24h stars +1827，总 stars 47,936，适合看近期 release、commit 或社区讨论是否解释了增长。
...
- **Stars:** 18,285 (+867 / 24h, n/a / 7d)
- **Category:** AI Agent Framework
- **Why it matters:** AI Agent Framework 方向保持持续热门，24h stars +867，总 stars 18,285，适合看近期 release、commit 或社区讨论是否解释了增长。
...
### 8. milvus-io/milvus
- **Stars:** 44,915 (+37 / 24h, +121 / 7d)
- **Category:** Vector Database / Embedding
- **Why it matters:** Vector Database / Embedding 方向出现突然加速：24h stars +37，前 3 日均值 12.7，加速度 2.9x，今天值得优先排查触发原因。
- **Developer insight:** 可以用一个最小样例验证 API、文档和集成成本，再决定是否纳入长期技术观察。
- **Risk:** Low
...
### 10. siyuan-note/siyuan
- **Stars:** 44,570 (+27 / 24h, +102 / 7d)
- **Category:** RAG / Knowledge Base
- **Why it matters:** RAG / Knowledge Base 方向出现突然加速：24h stars +27，前 3 日均值 12.3，加速度 2.2x，今天值得优先排查触发原因。
...
- **Stars:** 14,359 (+5,001 / 24h, n/a / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向出现突然加速：24h stars +5001，前 3 日均值 1334.7，加速度 3.7x，今天值得优先排查触发原因。
- **Developer insight:** 关注它如何拆解代码任务、接入工具和处理仓库上下文，可作为 coding agent 产品能力参考。
- **Risk:** Low
- [View on GitHub](https://github.com/calesthio/OpenMontage)

### 12. mukul975/Anthropic-Cybersecurity-Skills
- **Stars:** 19,292 (+1,415 / 24h, +8,157 / 7d)
- **Category:** Coding Agent / SWE Agent
- **Why it matters:** Coding Agent / SWE Agent 方向保持持续热门，24h stars +1415，总 stars 19,292，适合看近期 release、commit 或社区讨论是否解释了增长。
- **Developer insight:** 关注它如何拆解代码任务、接入工具和处理仓库上下文，可作为 coding agent 产品能力参考。
- **Risk:** Low
